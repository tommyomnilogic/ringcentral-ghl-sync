...
export async function searchContactByPhone(phone) {
  ...
  // Try searching with last 10 digits
  const url = `${GHL_BASE}/contacts/search?locationId=${LOCATION_ID}&query=${encodeURIComponent(last10)}&limit=20`;
  ...
  // Match by normalizing both to last 10 digits
